...
setosa_covariance = np.diag(np.diag(setosa_covariance))
versicolor_covariance = np.diag(np.diag(versicolor_covariance))
virginica_covariance = np.diag(np.diag(virginica_covariance))

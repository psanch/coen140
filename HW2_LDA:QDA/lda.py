...
#SET COVARIANCES TO AVERAGE

average_covariance = (setosa_covariance + versicolor_covariance + virginica_covariance) / 3

setosa_covariance = average_covariance
versicolor_covariance = average_covariance
virginica_covariance = average_covariance
...
for i in range(40):
	...
	prediction = max(p_setosa,p_versicolor,p_virginica)
	if(prediction != p_setosa): 
		num_train_incorrect = num_train_incorrect + 1
		print("setosa incorrect!")
...
for i in range(40):
	...
	prediction = max(p_setosa,p_versicolor,p_virginica)
	if(prediction != p_versicolor): 
		num_train_incorrect = num_train_incorrect + 1
		print("versicolor incorrect!")
	num_train_total = num_train_total + 1
...
for i in range(40):
	...
	prediction = max(p_setosa,p_versicolor,p_virginica)
	if(prediction != p_virginica):
		num_train_incorrect = num_train_incorrect + 1
		print("virginica incorrect!")
	num_train_total = num_train_total + 1
...
print("\nSince training error != 0 we can say NO TWO CATEGORIES ARE LINEARLY SEPARABLE\n")

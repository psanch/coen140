...
for i in range(40):
    ...
    dataset_iris[i] = dataset_iris[i][2:-1]
...
#CALCULATE mu's
setosa_mu = np.zeros(range_features)
versicolor_mu = np.zeros(range_features)
virginica_mu = np.zeros(range_features)
...
setosa_covariance = np.zeros((range_features,range_features))
versicolor_covariance = np.zeros((range_features,range_features))
virginica_covariance = np.zeros((range_features,range_features))
